...
- Para la realizacion de este proyecto se utilizaron las siguientes tecnologias:
  ...
  - [Jsx](https://es.wikipedia.org/wiki/JSX_(JavaScript)): Es una extensión de JavaScript que permite la creación de árboles DOM usando una sintaxis similar a XML
  - [Javascript](https://es.wikipedia.org/wiki/JavaScript): Lenguaje de programación que permite hacer páginas web interactivas y dinámicas, funcionando junto a HTML y CSS para crear experiencias web completas. Se utiliza para tareas como animar elementos, validar formularios, cargar contenido sin recargar la página y crear juegos, entre otras cosas.
  - [react](https://es.wikipedia.org/wiki/React): Es una biblioteca de JavaScript de código abierto para crear interfaces de usuario (UI) interactivas en aplicaciones web y móviles. Se enfoca en la creación de componentes reutilizables, lo que simplifica el desarrollo de UIs complejas.
  - [Netlify](https://en.wikipedia.org/wiki/Netlify): Es una plataforma en la nube que automatiza y simplifica el proceso de creación, alojamiento y despliegue de sitios web y aplicaciones web modernas, como sitios estáticos y aplicaciones de una sola página.
